package com.ccu.skintears.pdfrenderer;
...
public class MainActivityPDF extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.pdfdoc1).setOnClickListener(this);
    ...
    private void OpenPdfActivity(String absolutePath) {
        ...
        PDFView.with(MainActivityPDF.this)
