...
public class Constant {
    ...
    public static ArrayList<NavMenuModel> getMenuNavigasi(){
        ...
        menu.add(new NavMenuModel("Evaluaciones", R.drawable.ic_test,
                new ArrayList<NavMenuModel.SubMenuModel>() {{
                    add(new NavMenuModel.SubMenuModel("Evaluación Módulo 1", EvaluacionMod1Fragment.newInstance("Suerte")));
                    add(new NavMenuModel.SubMenuModel("Evaluación Módulo 2", EvaluacionMod2Fragment.newInstance("Suerte")));
                    add(new NavMenuModel.SubMenuModel("Evaluación Módulo 3", EvaluacionMod3Fragment.newInstance("Suerte")));
