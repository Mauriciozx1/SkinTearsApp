package cl.ccu.skintears.activities.evaluaciones;
...
public class PreguntasEvaluacion extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluacion_preguntas);
        ...
        Cursor preguntas = this.mgtDB.getPreguntas(DBPref.Categoria.CINE, DBPref.Dificultad.FACIL, PreguntasEvaluacion.NUM_PREGUNTA);
    ...
    private void setPregunta(Pregunta pregunta) {
        ...
        if (this.pregunta.getTipo() == 1) {
            ...
            this.sonPregunta = MediaPlayer.create(this, Uri.parse("android.resource://cl.ccu.skintears/raw/" + this.pregunta.getSonido()));
    ...
    public void onClick(View view) {
        ...
        if (seleccionado.getText().toString().equals(this.pregunta.getRespuesta())) {
            ...
            if (iterator.hasNext()) {
                ...
                this.startActivity(new Intent(PreguntasEvaluacion.this, Despedida.class));
            }
        } else {
            this.sonError.start();
            ...
            builder
                    .setMessage("Respuesta Incorrecta.\n\nPuede intentarlo nuevamente pero le quitará 1 punto...")
                    ...
                    .setNegativeButton("Salir y Comenzar nuevamente", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int id) {
    ...
    public void mostrarRespuesta() {
        Toast.makeText(this, "Respuesta Correcta: " + this.pregunta.getRespuesta(), Toast.LENGTH_LONG).show();
    }
