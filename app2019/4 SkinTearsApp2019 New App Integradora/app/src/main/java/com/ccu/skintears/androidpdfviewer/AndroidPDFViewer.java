package com.ccu.skintears.androidpdfviewer;
...
public class AndroidPDFViewer extends AppCompatActivity {
    ...
    private static final String FILE_NAME1 = "guideline.pdf";
    private static final String FILE_NAME2 = "classificationsystem.pdf";
    private static final String FILE_NAME3 = "contenido1.pdf";
    private static final String FILE_NAME4 = "contenido2.pdf";
    ...
    void openPdfWithAndroidSDK(ImageView imageView, int pageNumber) throws IOException {
        // Copy guidelineine.pdf from raw resource folder into local cache, so PdfRenderer can handle it

        File fileCopy = new File(getCacheDir(), FILE_NAME1);
        copyToLocalCache(fileCopy, R.raw.guideline);

        File fileCopy2 = new File(getCacheDir(), FILE_NAME2);
        copyToLocalCache(fileCopy2, R.raw.classificationsystem);

        File fileCopy3 = new File(getCacheDir(), FILE_NAME3);
        copyToLocalCache(fileCopy3, R.raw.contenido1);

        File fileCopy4 = new File(getCacheDir(), FILE_NAME4);
        copyToLocalCache(fileCopy4, R.raw.contenido2);
